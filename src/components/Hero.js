...
const Hero = () => {
    return (
        <Router>
        <div className="bg-contain bg-hero-image-mobile sm:bg-hero-image-desktop bg-right-top bg-no-repeat text-center px-8 md:px-20 mb-16 lg:px-60">
  ...
  copy. Instantly access your clipboard on all your devices.</p>
            ...
            <div className="mt-16 grid max-w-xs m-auto xl:grid-cols-2 xl:max-w-xl">
